...
Разобран реверс-инжинирингом Холста (holst.ru) и подтверждён экспериментально:
сгенерированный по этому описанию файл открывается со всеми объектами, связями
и форматированием. Официальной спецификации нет, поэтому формат может измениться
без предупреждения.
