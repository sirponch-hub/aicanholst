---
name: holst-board
description: "Создание и чтение файлов досок Холст (.holst, holst.ru) — генерация доски со стикерами, фреймами, фигурами и связями, либо разбор существующей выгрузки. Use when the user mentions .holst files, доску Холста, holst.ru board, or asks to build, generate or parse a Holst whiteboard export."
license: MIT
---

# Доски Холст (.holst)

Создание и чтение файлов онлайн-доски Холст (holst.ru). Формат разобран
реверс-инжинирингом и подтверждён экспериментально: сгенерированный файл
